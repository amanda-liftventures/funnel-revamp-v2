# 07-q-how-often — "How often do you read books?"

Figma node: `7815:31520` ("Step 70") · File key: `2T3j73CQ4BKfuuXPnb0qFi` · Frame: 390 x 844
Screenshot: `design-specs/screens/07-q-how-often.png`

## Exact copy (verbatim)

- Status bar time: `9:41`
- Browser chrome URL: `supersummary.com`
- Question title: `How often do you read books?`
- Options (in order): `Daily`, `Weekly`, `Monthly`, `Rarely`
- No footer / Next button on this screen (advance on selection).

## Layout structure

```
Step 70 (390x844, white bg, column flex, gap 0)
...
│       (Same fill width as screen 06 — identical progress state.)
├── Content (flex 1, column, gap 0, full width)
│   ├── Title (390w, height 96px, column, gap 4px, padding 16px, justify center)
│   │   └── H "How often do you read books?" — full width, left-aligned
│   └── Options list (full width, column, gap 16px, items CENTER, padding-x 16px, padding-y 24px)
│       └── 4 x <Radio Button> (style Icon, state Default, unchecked):
│           - full width, height 48px, row, gap 8px, padding-x 24px, padding-y 8px, items center
│           - bg rgba(255,255,255,0.01) (Semantic/transparent); border 1px solid #bfbfbf; radius 100px (pill)
│           - leading icon 18x18 "Style=Outlined" (glyph inset 8.33% v / 12.5% h) — DIFFERENT icon per option (see below)
│           - label text #616161
```
...
- Footer: none — no Next button; single-select advances the flow.

## Option list details

- Style: radio-button pills (`<Radio Button>`, ds/radio-button, variant State=Default, Type=Default, Style=Icon) — exclusive single-select; leading icon + label, no visible radio circle.
- All options shown unselected (Default). Checked fill per component docs: Semantic/interactive-primary (#006c7a).
- Icons per option (outlined style, 18x18, calendar family from design-system icon set):
  - `Daily` → **today** icon (calendar with dot marking today)
  - `Weekly` → **date_range** icon (calendar with range marks)
  - `Monthly` → **calendar_month** icon (calendar month grid)
  - `Rarely` → **event_busy** icon (calendar with X)
- A11y: role=radio, aria-checked, role=radiogroup container, arrow-key navigation.

## Downloaded assets (design-specs/assets/07-q-how-often/)
...
| icon-daily-today.svg | "Daily" option leading icon (today) |
| icon-weekly-date-range.svg | "Weekly" option leading icon (date_range) |
| icon-monthly-calendar-month.svg | "Monthly" option leading icon (calendar_month) |
| icon-rarely-event-busy.svg | "Rarely" option leading icon (event_busy) |

## Raw reference code (get_design_context output)

```tsx
const imgVector = "https://www.figma.com/api/mcp/asset/754d07fb-c159-42a4-a0de-b6047fb082a6.svg";
const imgRectangle = "https://www.figma.com/api/mcp/asset/e7db5326-66e7-4473-8bd0-83d694e1dd97.svg";
const imgCombinedShape = "https://www.figma.com/api/mcp/asset/a700a1a8-6fa9-4af6-af92-e2b46f031371.svg";
const imgRectangle1 = "https://www.figma.com/api/mcp/asset/120af950-fc52-4bfa-83ea-77bbd0881ec8.svg";
const imgWifi = "https://www.figma.com/api/mcp/asset/fc56cb8f-5db2-4855-ba34-e49bc0ae84b8.svg";
const imgMobileSignal = "https://www.figma.com/api/mcp/asset/569bc4bd-7f2d-47a7-b844-2d75c93a5ff3.svg";
const img941 = "https://www.figma.com/api/mcp/asset/e9584130-48e1-44d6-b3fc-9f974c2b56e5.svg";
const imgShare = "https://www.figma.com/api/mcp/asset/43cd5bd4-ab28-4f9d-96b6-06b65d1c8d5c.svg";
const imgLock = "https://www.figma.com/api/mcp/asset/c3c1d604-0e44-432c-ba72-b0452a703a90.svg";
const imgVector1 = "https://www.figma.com/api/mcp/asset/aec8bb13-6aec-4735-969a-bd52040b46ec.svg";
const imgVector2 = "https://www.figma.com/api/mcp/asset/9dbb01cb-2e87-43ba-9928-f16446c53b3e.svg";
const imgVector3 = "https://www.figma.com/api/mcp/asset/1a6748e3-8ac6-40fd-9b82-7e5f844f0fad.svg";
const imgVector4 = "https://www.figma.com/api/mcp/asset/d4d50931-c5c9-4b34-b2ee-fc0da8401078.svg";
...
export default function Step70() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[var(--0,0px)] items-start relative size-full" data-node-id="7815:31520" data-name="Step 70">
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[var(--0,0px)] items-start min-h-px relative w-full" data-node-id="7815:31523" data-name="Content">
        <div className="content-stretch flex flex-col gap-[var(--4,4px)] h-[96px] items-start justify-center p-[var(--16,16px)] relative shrink-0 w-[390px]" data-node-id="7815:31524" data-name="Title">
          <p className="[word-break:break-word] font-[family-name:var(--font-family\/fontfamily-display,'General_Sans:Medium')] leading-[1.3] not-italic relative shrink-0 text-[color:var(--semantic\/text-primary,#212121)] text-[length:var(--font-size\/1\,5rem,24px)] tracking-[0.25px] w-full" data-node-id="7815:31525">
            How often do you read books?
          </p>
        </div>
        <div className="content-stretch flex flex-col gap-[var(--16,16px)] items-center px-[var(--16,16px)] py-[var(--24,24px)] relative shrink-0 w-full" data-node-id="7815:31575">
          <div className="bg-[var(--semantic\/transparent,rgba(255,255,255,0.01))] border border-[var(--semantic\/border-main,#bfbfbf)] border-solid content-stretch flex gap-[var(--8,8px)] h-[48px] items-center px-[var(--24,24px)] py-[var(--8,8px)] relative rounded-[var(--rounded,100px)] shrink-0 w-full" data-node-id="7815:31576" data-name="<Radio Button>">
            <div className="content-stretch flex items-center relative shrink-0" data-node-id="I7815:31576;1543:2388" data-name="Icon">
              <div className="overflow-clip relative shrink-0 size-[18px]" data-node-id="I7815:31576;1543:2385" data-name="Style=Outlined">
                <div className="absolute inset-[8.33%_12.5%]" data-node-id="I7815:31576;1543:2385;2402:38488" data-name="Vector">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector1} />
                </div>
              </div>
            </div>
            <p className="[word-break:break-word] font-[family-name:var(--font-family\/fontfamily-default,'Open_Sans:Regular')] font-[var(--font-weight\/fontweightregular,400)] leading-[1.5] relative shrink-0 text-[color:var(--semantic\/text-secondary,#616161)] text-[length:var(--font-size\/1rem,16px)] tracking-[0.25px] whitespace-nowrap" data-node-id="I7815:31576;1543:2377" style={{ fontVariationSettings: '"wdth" 100' }}>
              Daily
            </p>
          </div>
          <div className="bg-[var(--semantic\/transparent,rgba(255,255,255,0.01))] border border-[var(--semantic\/border-main,#bfbfbf)] border-solid content-stretch flex gap-[var(--8,8px)] h-[48px] items-center px-[var(--24,24px)] py-[var(--8,8px)] relative rounded-[var(--rounded,100px)] shrink-0 w-full" data-node-id="7815:31577" data-name="<Radio Button>">
            <div className="content-stretch flex items-center relative shrink-0" data-node-id="I7815:31577;1543:2388" data-name="Icon">
              <div className="overflow-clip relative shrink-0 size-[18px]" data-node-id="I7815:31577;1543:2385" data-name="Style=Outlined">
                <div className="absolute inset-[8.33%_12.5%]" data-node-id="I7815:31577;1543:2385;2402:31138" data-name="Vector">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector2} />
                </div>
              </div>
            </div>
            <p className="[word-break:break-word] font-[family-name:var(--font-family\/fontfamily-default,'Open_Sans:Regular')] font-[var(--font-weight\/fontweightregular,400)] leading-[1.5] relative shrink-0 text-[color:var(--semantic\/text-secondary,#616161)] text-[length:var(--font-size\/1rem,16px)] tracking-[0.25px] whitespace-nowrap" data-node-id="I7815:31577;1543:2377" style={{ fontVariationSettings: '"wdth" 100' }}>
              Weekly
            </p>
          </div>
          <div className="bg-[var(--semantic\/transparent,rgba(255,255,255,0.01))] border border-[var(--semantic\/border-main,#bfbfbf)] border-solid content-stretch flex gap-[var(--8,8px)] h-[48px] items-center px-[var(--24,24px)] py-[var(--8,8px)] relative rounded-[var(--rounded,100px)] shrink-0 w-full" data-node-id="7815:31578" data-name="<Radio Button>">
            <div className="content-stretch flex items-center relative shrink-0" data-node-id="I7815:31578;1543:2388" data-name="Icon">
              <div className="overflow-clip relative shrink-0 size-[18px]" data-node-id="I7815:31578;1543:2385" data-name="Style=Outlined">
                <div className="absolute inset-[8.33%_12.5%]" data-node-id="I7815:31578;1543:2385;2402:30244" data-name="Vector">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector3} />
                </div>
              </div>
            </div>
            <p className="[word-break:break-word] font-[family-name:var(--font-family\/fontfamily-default,'Open_Sans:Regular')] font-[var(--font-weight\/fontweightregular,400)] leading-[1.5] relative shrink-0 text-[color:var(--semantic\/text-secondary,#616161)] text-[length:var(--font-size\/1rem,16px)] tracking-[0.25px] whitespace-nowrap" data-node-id="I7815:31578;1543:2377" style={{ fontVariationSettings: '"wdth" 100' }}>
              Monthly
            </p>
          </div>
          <div className="bg-[var(--semantic\/transparent,rgba(255,255,255,0.01))] border border-[var(--semantic\/border-main,#bfbfbf)] border-solid content-stretch flex gap-[var(--8,8px)] h-[48px] items-center px-[var(--24,24px)] py-[var(--8,8px)] relative rounded-[var(--rounded,100px)] shrink-0 w-full" data-node-id="7815:31579" data-name="<Radio Button>">
            <div className="content-stretch flex items-center relative shrink-0" data-node-id="I7815:31579;1543:2388" data-name="Icon">
              <div className="overflow-clip relative shrink-0 size-[18px]" data-node-id="I7815:31579;1543:2385" data-name="Style=Outlined">
                <div className="absolute inset-[8.33%_12.5%]" data-node-id="I7815:31579;1543:2385;2402:75271" data-name="Vector">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector4} />
                </div>
              </div>
            </div>
            <p className="[word-break:break-word] font-[family-name:var(--font-family\/fontfamily-default,'Open_Sans:Regular')] font-[var(--font-weight\/fontweightregular,400)] leading-[1.5] relative shrink-0 text-[color:var(--semantic\/text-secondary,#616161)] text-[length:var(--font-size\/1rem,16px)] tracking-[0.25px] whitespace-nowrap" data-node-id="I7815:31579;1543:2377" style={{ fontVariationSettings: '"wdth" 100' }}>
              Rarely
            </p>
          </div>
        </div>
